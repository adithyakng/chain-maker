import json
import logging
from makeChain import State, Attack, AttackDB
...
def create_attack(data):
    return [Attack(attack['name'], State(attack['initState']), State(attack['endState']),set(attack['info_required']), set(attack['info_gained']), attack['id']) for attack in data]
